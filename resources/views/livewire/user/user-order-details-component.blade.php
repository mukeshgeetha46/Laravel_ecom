                    ...
                    <div class="panel-heading">
                     ...
                     <div class="panel-body">
                         <table class="table">
                             <tr>
                                <th>Transaction</th>
                                <td>{{((empty($order->transaction->mode) || is_null($order->transaction->mode))? '-' : $order->transaction->mode)}}</td>
                             </tr>
                             <tr>
                                <th>Status</th>

                                <td>{{((empty($order->transaction->status) || is_null($order->transaction->status))? '-' : $order->transaction->status)}}</td>
                             </tr>
                             <tr>
                                <th>Transaction Date</th>
                                <td>{{((empty($order->transaction->created_at) || is_null($order->transaction->created_at))? '-' : $order->transaction->created_at)}}</td>
