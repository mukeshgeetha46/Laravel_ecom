	...
	<main id="main" class="main-site left-sidebar">
		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="wrap-shop-control">
						...
						<div class="wrap-right">
							...
							<div class="sort-item orderby ">
								<select name="orderby" class="use-chosen"   id="sorting">
							...
							<div class="sort-item product-per-page">
								<select name="post-per-page" class="use-chosen" id="pagesize">
			 ...
			 <div class="productdata" id="productdata">
				<div class="row" id="prouctrow">

					<ul class="product-list grid-products equal-container" id="productlist">
					@php
						...
						<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
							<div class="product product-style-3 equal-elem ">
								...
								<div class="product-info">
									...
									{{-- //<a href="#" id="addtocart" class="btn add-to-cart" onclick="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Add To Cart</a> --}}

									<div class="product-wish">
										@if ($witems->contains($product->id))
										<a href="#" id="removewishlist" data-id="{{$product->id}}"><i class="fa fa-heart fill-heart"></i></a>

										@else
										<a href="#" id="addwishlist" data-id="{{$product->id}}" data-name="{{$product->name}}" data-price="{{$product->regular_price}}"><i class="fa fa-heart"></i></a>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget filter-widget price-filter"> 
						<h2 class="widget-title">Price <span class="text-info">$<span id="minval"></span> - $<span id="maxval"></span></span></h2>
						<div class="widget-content">
							<div id="slider"></div>
						</div>
					</div><!-- Price-->
...
<script>
	$(document).on('change','#sorting',function(){
		...
		var pagesize = $('#pagesize').val();
		var minval = $('#minval').text();
		var maxval = $('#maxval').text();
		console.log(minval);
		$.ajax({
	url: "{{route('sortingproduct')}}",
    type: 'POST',
