		...
		<div class="container">
			...
			<div class="summary">
			   ...
			   @endif
				...
				<div class="wrap-iten-in-cart">
					<h3 class="title-box" style="border-bottom: 1px solid;padding: 15px;">{{Cart::instance('SaveForLater')->count()}} items(s) Saved For Later</h3>
				
					@if(Cart::instance('SaveForLater')->count()>0)
					<h4 class="box-title">Products Name</h4>
					@if(Session::has('success_message'))
					<div class="alert alert-success">
                      <strong>Success</strong> {{Session::get('success_message')}}
					</div>
