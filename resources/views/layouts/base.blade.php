						...
						<div class="topbar-menu right-menu">
							<ul>
                                ...
                                @if(Route::has('login'))
									...
									<a title="My Profile" href="#">Profile<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency" >
										...
										<li class="menu-item">
                                          <a title="Categories" href="{{route('admin.categories')}}">Catogries</a>
										</li>
										<li class="menu-item">
                                        ...
                                        <li class="menu-item" action="{{route('logout')}}">
                                    ...
                                    @else
                                    <li class="menu-item menu-item-has-children parent" >
									<a title="My Profile" href="#">Dollar (USD)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu curency" >
										<li class="menu-item" >
                                        <a title="My Account" href="#">My Account ({{Auth::user()->name}})</a>
										</li>
...
{{$slot}}
	...
	<script src="https://cdn.tiny.cloud/1/rf55bvdu01iv7q3vgpkvjz33fnrowuf4cox2x8fpemp3zapi/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
	@stack('scripts')
